      ...
      <div class="col-md-12">
        ...
        <div class="category-carousel swiper">
          <div class="swiper-wrapper">
            ...
            <a href="javascript::void(0)" class="nav-link category-item swiper-slide">
              <img src="images/icon-vegetables-broccoli.png" alt="Category Thumbnail">
              <h3 class="category-title">{{$cat->cate_name}}</h3>
            </a>
            @endforeach
          </div>
        </div>
                ...
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body py-0">
                      <p class="text-muted mb-0">Dynamic Brands</p>
        ...
        <div class="products-carousel swiper">
          <div class="swiper-wrapper">
            ...
            <div class="product-item swiper-slide">
              ...
              <figure>
                <a href="javascript:void(0)" title="Dynamic Product images are only static">
                  <img src="https://w0.peakpx.com/wallpaper/168/813/HD-wallpaper-apples-fruit-ripe-red-apples-beautiful-fruit-thumbnail.jpg" width="250px" class="tab-image">
                </a>
              </figure>
